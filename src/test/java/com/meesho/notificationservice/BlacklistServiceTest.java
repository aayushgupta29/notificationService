...
public class BlacklistServiceTest {
    ...
    public void getBlacklistNumbersTest(){
        ...
        when(redisTemplate.keys("+*")).thenReturn(new HashSet<>(Collections.singletonList("+912345678901")));
    ...
    public void deleteBlacklistNumbersTest(){
        ...
        verify(redisTemplate, times(1)).delete(blacklistPhoneNumbers.get(0).getPhoneNumber());
